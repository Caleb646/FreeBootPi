...
#define SCTLR_RESERVED          (1 << 31) | (3 << 26) | (0b1111 << 21) | (0b1111 << 14) | (0b1111111 << 3)
...
#define SCTLR_EL1_VALUE         (\
                                SCTLR_RESERVED | \
                                SCTLR_I_CACHE_ENABLED | \
                                SCTLR_EL1_SP_ALIGNMENT_CHECK_EL0 | \
                                SCTLR_EL1_SP_ALIGNMENT_CHECK_EL1 | \
                                SCTLR_D_CACHE_ENABLED \
                                ) \
