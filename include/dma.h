...
#define DMA_TF_INFO_INT_ENABLE_BIT (1 << 0)
...
#define DMA_CHANNEL_IS_ACTIVE(channel_id) \
    ((read32 (DMA_CS (channel_id)) & DMA_CS_DMA_ACTIVE_BIT) == DMA_CS_DMA_ACTIVE_BIT)
#define DMA_CHANNEL_HAS_ERROR(channel_id) \
    ((read32 (DMA_CS (channel_id)) & DMA_CS_ERROR_BIT) == DMA_CS_ERROR_BIT)
