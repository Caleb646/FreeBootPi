...
void mini_uart_init(void)
{
     ...
     * 11 = Reserved 
   */
    // selector = read32(GPIO_PUP_PDN_CNTRL_REG0);  
    // selector &= 0x0FFFFFFF; 
    // write32(GPIO_PUP_PDN_CNTRL_REG0, selector);
    // delay(150);
...
void uart_init(void)
{
    ...
    // write32(UART0_CR, 0);
    // write32(UART0_IBRD, 26);
    // write32(UART0_FBRD, 3);
    // write32(UART0_LCRH, (1 << 4) | (3 << 5));
    // write32(UART0_CR, 1 | (1 << 8) | (1 << 9));
}
